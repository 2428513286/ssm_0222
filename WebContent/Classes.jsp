...
$(function(){
	...
	$("#dg").datagrid({
		...
		columns:[[
			{field:"",checkbox:true},
			{field:"id",title:"班级编号",width:100,align:"center"},
	...
	$("#export_btn").click(function(){
		$.messager.confirm("确定信息","确定要下载Classes.xls文件吗？",function(r){
			if(r){
				location.href="ClassesServlet?opType=downloadxls&fileName=Classes.xls"
			}
		});
	});
	//点击导入
	$("#upload").click(function(){
		$.messager.confirm("确定信息",$("#sc").val(),function(r){
			if(r){
				location.href="ClassesServlet?opType=uploadxls&file="+$("#sc").val()
			}
		});
	});
...
<body>
	<div style="height: 5%">
		<form name="searchform" method="post" id ="searchform">
			...
			班级名称：<input type="text" name="qname" class="easyui-textbox">
